...
from .gdscript_objects import Element, GDScriptClass, GDScriptClasses, Function, ProjectInfo, Member, BUILTIN_CLASSES
...
def _as_markdown(classes: GDScriptClasses, gdscript: GDScriptClass, arguments: Namespace) -> MarkdownDocument:
    ...
    # content += [
    #     "",
    #     "- " + surround_with_html(make_link("Signals", "#signals"), "small"),
    #     "",
    #     "- " + surround_with_html(make_link("Enums", "#enumerations"), "small"),
    #     "",
    #     "- " + surround_with_html(make_link("Constants", "#constants-descriptions"), "small"),
    #     "",
    #     "- " + surround_with_html(make_link("Properties", "#property-descriptions"), "small"),
    #     "",
    #     "- " + surround_with_html(make_link("Method Descriptions", "#method-descriptions"), "small"),
    # ]
...
def _replace_references(classes: GDScriptClasses, gdscript: GDScriptClass, description: str) -> str:
